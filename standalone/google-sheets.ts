/**
 * Google Sheets API service for appending TSV data to sheets (ES modules version)
...
import { SERVICE_ACCOUNT } from "../extension/config/service-account.ts";
import { createJWTAssertion, getAccessTokenFromJWT } from "../extension/utils/jwt.ts";
